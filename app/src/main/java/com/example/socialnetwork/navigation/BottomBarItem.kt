...
enum class BottomBarItem(
    ...
    Search(SearchScreenDestination, Icons.Default.Person, R.string.bottom_bar_item_search),
    Friends(FriendsScreenDestination, Icons.Default.Settings, R.string.bottom_bar_item_friends),
